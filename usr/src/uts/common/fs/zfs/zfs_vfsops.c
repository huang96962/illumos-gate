...
zfs_mountroot(vfs_t *vfsp, enum whymountroot why)
{
	...
	if (why == ROOT_INIT) {
		...
		//cmn_err(CE_NOTE, "zfs-bootfs=%s, rootfs.bo_name=%s, diskdevid=%s, zfs-bootpool=%llu, zfs-bootvdev=%llu",
		    //zfs_bootfs, rootfs.bo_name, zfs_devid, (u_longlong_t)zfs_bootpool, (u_longlong_t)zfs_bootvdev);
